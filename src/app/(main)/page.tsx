            ...
            <div className="space-y-8">
              ...
              <div className="bg-white p-2 rounded-2xl shadow-2xl flex flex-col md:flex-row gap-2 max-w-2xl">
                ...
                <div className="flex-1 flex items-center gap-3 px-4 py-3">
                  <Home className="text-gold-immo" size={20} />
                  <select className="w-full outline-none text-indigo-immo font-medium bg-transparent cursor-pointer">
                ...
                <Link href="/search" className="btn-secondary flex items-center justify-center gap-2 py-4 px-8">
                  <Search size={20} />
                  Rechercher
                </Link>
              </div>
              ...
              <div className="flex items-center gap-8 pt-4">
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-indigo-300">Biens vérifiés</span>
                </div>
                <div className="w-px h-10 bg-white/20"></div>
                <div className="flex flex-col">
                  <span className="text-3xl font-bold text-white">12k+</span>
                  <span className="text-sm text-indigo-300">Utilisateurs actifs</span>
                </div>
              </div>
            </div>
